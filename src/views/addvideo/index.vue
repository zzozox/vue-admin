<template>
  <div class="app-container">
    ...
    <ele-upload-video
      ...
      style="margin: 50px"
      action="http://localhost:8083/milimili/adminVideoUpload"
...
export default {
  ...
  data() {
    return {
      ...
      image: '',
      uploadUrl: 'http://localhost:8083/milimili/admin/thumbnailImageupload?videoId='
    }
  },
  created() {
    this.fetchDataById()
  ...
  methods: {
    ...
    fetchDataById() {
      ...
      this.axios({
        method: 'GET',
        url: 'http://localhost:8083/milimili/admin/getVideoStateList'
      }).then(function(resp) {
    ...
    onSubmit() {
      ...
      this.axios({
        method: 'POST',
        data: vm.video,
        url: 'http://localhost:8083/milimili/admin/addVideo',
