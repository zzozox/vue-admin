...
export default {
  ...
  data() {
    return {
      ...
      user: {
        ...
        'iconUrl': 'static/uimages/icon1.jpg',
        'stateId': 1
      },
      // eslint-disable-next-line no-undef
      image: '',
      imageInfo: '',
      uploadUrl: 'http://localhost:8083/milimili/admin/upload?userId='
    }
  },
  created() {
    this.fetchDataById()
  ...
  methods: {
    fetchDataById() {
      ...
      this.axios({
        method: 'GET',
        url: 'http://localhost:8083/milimili/admin/getUserById?id=' + id
      }).then(function(resp) {
        vm.user = resp.data
      })
    },
    fetchIconById() {
      ...
      this.axios({
        method: 'POST',
        url: 'http://localhost:8083/milimili/admin/getIcon?userId=' + id
      }).then(function(res) {
    ...
    onSubmit() {
      ...
      this.axios({
        method: 'POST',
        url: 'http://localhost:8083/milimili/admin/editUser',
        headers: {
